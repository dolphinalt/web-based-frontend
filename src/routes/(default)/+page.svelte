...
<div class="flex px-8 py-24 bg-gray-600 h-screen w-screen">
    <div class="flex flex-col bg-gray-700 border-gray-800 border-2 rounded-lg shadow-xl w-96 md:w-1/2 h-fit p-8">
        <h1 class="text-white text-3xl font-bold mb-4">Welcome to Boeing!</h1>
        ...
        <p class="text-white mb-6">Proceed to Challenges when you have started. Good luck!</p>
        <a href="{challengePageUrl}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded">Go to Challenges</a>
    </div>
